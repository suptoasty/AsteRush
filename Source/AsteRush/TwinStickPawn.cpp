...
const FName ATwinStickPawn::MoveForwardBinding("MoveForward");
const FName ATwinStickPawn::MoveRightBinding("MoveRight");
const FName ATwinStickPawn::FireForwardBinding("FireForward");
const FName ATwinStickPawn::FireRightBinding("FireRight");
...
void ATwinStickPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ATwinStickPawn::Tick(float DeltaSeconds)
{
